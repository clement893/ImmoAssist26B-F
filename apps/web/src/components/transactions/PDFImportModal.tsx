          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <label
                  htmlFor="pdf-upload"
                  className="flex items-center gap-2 px-4 py-2 border border-border rounded-lg cursor-pointer hover:bg-muted transition-modern" // UI Revamp - Transition moderne
                >
