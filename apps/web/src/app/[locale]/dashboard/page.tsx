        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-9 space-y-6">
            ...
            <MotionDiv variant="slideUp" delay={200}>
              <div>
                <h2 className="text-2xl font-light text-gray-900 mb-6">Statistiques des transactions</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <MotionDiv variant="slideUp" delay={250}>
              <div>
                <h2 className="text-2xl font-light text-gray-900 mb-6">Réseau et finances</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card variant="elevated" className="h-full">
                  ...
                  <div className="space-y-4">
                    <div className="p-6 bg-success-50 dark:bg-success-950/20 rounded-2xl border-2 border-success-200 dark:border-success-800">
                    ...
                    <div className="p-6 bg-warning-50 dark:bg-warning-950/20 rounded-2xl border-2 border-warning-200 dark:border-warning-800">
                      <div className="flex items-center justify-between mb-2">
            ...
            <MotionDiv variant="slideUp" delay={350}>
              <div className="grid grid-cols-1 gap-6">
                <Link href="/dashboard/modules/calendrier" className="block">
                  <Card variant="elevated" className="h-full hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-4">
