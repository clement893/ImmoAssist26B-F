  ...
  const loadDemoForm = () => {
    const demoForms: Record<string, OACIQForm> = {
      'AOS': {
        ...
        description: 'Ce formulaire est une annexe obligatoire à l\'offre de service du courtier immobilier. Il précise les conditions particulières de la prestation de services et les engagements du courtier envers son client.',
      ...
      'DIA': {
        ...
        description: 'Déclaration obligatoire que le courtier doit remplir concernant l\'état et les caractéristiques de l\'immeuble. Ce document permet d\'informer l\'acheteur de tous les éléments importants relatifs à la propriété.',
        category: 'obligatoire',
      ...
      'PAI': {
        ...
        description: 'Formulaire de promesse d\'achat pour un immeuble résidentiel. Ce document engage l\'acheteur à acquérir la propriété selon les conditions spécifiées et constitue une offre formelle au vendeur.',
        category: 'obligatoire',
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-500">
                    ...
                    {form.version && <span>Version {form.version}</span>}
                    {form.fields?.type && (
                      <>
                        <span>•</span>
                        <span>{form.fields.type}</span>
                      </>
                    )}
                  </div>
                </div>
          ...
          <div className="col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                <Link
                  href={`/fr/demo/formulaires-oaciq-v2/${getFormCode()}/view`}
                ...
                <button
                  onClick={() => navigator.share?.({ title: getFormName(), url: window.location.href })}
                  className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-xl text-sm font-medium transition-colors border border-gray-200"
                >
              ...
              <div className="space-y-4">
                ...
                {form.fields?.type && (
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{form.fields.type}</p>
                  </div>
                )}
                ...
                {form.version && (
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{form.version}</p>
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {form.fields?.pdf_fr_url && (
                      <span className="px-2 py-1 bg-blue-50 text-blue-700 rounded text-xs font-medium">
                        Français
                      </span>
                    )}
                    {form.fields?.pdf_en_url && (
                      <span className="px-2 py-1 bg-blue-50 text-blue-700 rounded text-xs font-medium">
                        English
                      </span>
                    )}
