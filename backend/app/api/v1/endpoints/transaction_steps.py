...
async def get_transaction_steps(
    ...
    tx_data = {
        ...
        "inspection_condition_lifted_date": _get_date(transaction.inspection_condition_lifted_date),
        "financing_deadline": _get_date(transaction.financing_deadline),
        "financing_condition_lifted_date": _get_date(transaction.financing_condition_lifted_date),
        "expected_closing_date": _get_date(transaction.expected_closing_date),
        "buyer": buyer_name,
        "seller": seller_name,
