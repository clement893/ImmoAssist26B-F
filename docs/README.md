...
Bienvenue dans la documentation du template MODELE-NEXTJS-FULLSTACK.
...
- [Bonnes Pratiques de Sécurité](./SECURITY.md) - Guide des bonnes pratiques

### 🔧 Configuration

- [Configuration SendGrid](./SENDGRID_SETUP.md) - Configuration du service email
- [Configuration Stripe](./STRIPE_SETUP.md) - Configuration des paiements
- [Guide des Abonnements](./SUBSCRIPTIONS_GUIDE.md) - Système d'abonnements
...
- [Système Email](./EMAIL_SYSTEM.md) - Documentation du système email
...
├── SENDGRID_SETUP.md            # Configuration SendGrid
...
- **Nouveau sur le projet ?** → [Guide de Démarrage](../GETTING_STARTED.md)
- **Besoin d'aide ?** → [Dépannage](./TROUBLESHOOTING.md)
- **Écrire des tests ?** → [Guide des Tests](./TESTING.md)
- **Configurer SendGrid ?** → [Configuration SendGrid](./SENDGRID_SETUP.md)
- **Configurer Stripe ?** → [Configuration Stripe](./STRIPE_SETUP.md)
- **Questions de sécurité ?** → [Bonnes Pratiques de Sécurité](./SECURITY.md)

---

**Note:** Cette documentation est maintenue pour le template. Pour des questions spécifiques, veuillez consulter les guides correspondants.
